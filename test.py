...
# helt nederst i fila forklarer jeg en del innebygde funksjoner i python som brukes
...
#   map(f, l)
# map tar to parametre, en funksjon f og liste l
# den tar hvert element i l og bruker det som input til f
# den verdien som f returnerer blir lagt i en ny liste
# map-funksjonen returnerer en liste av lik størrelse som l
# som inneholder alle 'y-verdiene' fra respektive elementer
# i l som x

#   lambda parameter : funksjonskropp
# lambda er en funksjon som returnerer en anonym funksjon
# eksempel:
#     lambda x, y : 2 * x - y
# eksempelet kan brukes hvor enn du forventer en funksjon
# denne spesifike anonyme funksjon tar 2 parametre og returner
# en verdie kalkulert utifra dem

# samlet eksempel
# la oss doble alle verdiene i en liste
# input/kode >>> list(map(lambda x : 2 * x, [1,2,3,4]))
# output     >>> [2,4,6,8]
# her er argumentene til map følgende
#     f: lambdafunksjonen som dobler en verdi x
#     l: en anonym liste (altså referansefri)
